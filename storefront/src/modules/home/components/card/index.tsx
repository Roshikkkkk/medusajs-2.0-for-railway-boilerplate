...
const Card: React.FC<CardProps> = ({ category, isCentered = false }) => {
  ...
  return (
    <LocalizedClientLink
      ...
      className={`w-[309px] h-[450px] md:w-[480px] md:h-[500px] snap-center flex-shrink-0 rounded-large flex flex-col items-center justify-end bg-cover bg-center relative overflow-hidden transition-transform duration-300 md:hover:scale-105 ${
